  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(res => {
        ...
        this.setState({             // sets state with an object of arrays. Yet another failed attempt
          pBp: {
            ...this.state.pBp,
            results: tempResults,
        ...
        console.log(                          // returns arrays with expected results. Or maybe I'm reading them wrong. Could be.
          "State holds: ",
